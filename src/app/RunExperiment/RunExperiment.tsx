  ...
  const steps = [
    ...
    //{ name: 'Experiment Status', component: <ExperimentStatus /> },
    {
      ...
      steps: [
        ...
        { id: 4, name: 'Response Time', component: <><ExperimentDetails /> <Response_time_details data={data} setData={setData} /></>, canJumpTo: stepId >= 2, },
        { id: 5, name: 'Resource Usage', component: <><ExperimentDetails /> <Resource_usage_details data={data} setData={setData} /></>, canJumpTo: stepId >= 2, },
        { id: 6, name: 'Final Equation', component: <Final_equation data={data} setData={setData} />, hideClose: true, canJumpTo: stepId >= 2, }
      ]
    },
    {
      id: 7,
