...
const PerformanceTable = () => {
    ...
    const recommendations: Repository[] = [
        { monitoringStartTime: 'jan 01, 2023, 5:53:40 PM', monitoringEndTime: 'jan 15, 2023, 12:24:04 AM', podCount: '0', confidenceLevel: '0', capacityConfigmmr: '0', capacityConfigcpu: '0' },
    ];
