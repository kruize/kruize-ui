...
const NestedHeaderTable = ({ data }) => {
  ...
  const pageContent = (
    <>
      <PageSection variant={PageSectionVariants.light}>C1</PageSection>
      <PageSection>
  ...
  return (
    <>
      <Drawer isExpanded={isDrawerExpanded}>
        <DrawerContent data-ouia-component-id="instance-drawer" panelContent={'Namespace data to be decided'}>
          {pageContent}
        </DrawerContent>
      </Drawer>
    </>
