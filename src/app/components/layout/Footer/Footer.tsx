...
const Footer = () => {
  ...
  return (
    <React.Fragment>
      <PageSection
        className="land-c-footer__traditional pf-m-no-fill"
        style={{
          position: 'absolute',
          bottom: 0,
          left: 0,
      ...
      >
        <footer role="contentinfo" className="pf-l-flex pf-m-column pf-m-row-on-lg pf-m-align-items-center-on-lg">
          <a href="https://www.redhat.com" className="land-p-footer__logo" target="_blank" rel="noopener noreferrer">
            {/* <RhLogo /> */}
          </a>
          <div
          ...
          >
            <p className="copyright pf-m-spacer-xl-on-lg">©2023 Red Hat, Inc.</p>
            <nav>
              <ul className="pf-l-flex pf-m-column pf-m-row-on-md">
                ...
                <li>
                  <a className="nav-link land-p-footer__terms" href="https://access.redhat.com/help/terms/">
                    Terms of Use
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a id="teconsent" className="nav-link land-p-footer__cookies"></a>
                </li>
              </ul>
            </nav>
          </div>
      ...
      >
        <p>
          ...
          rather than generic industry data, to identify the browsers we need to support in alignment with our
          customers’ needs. Additionally, to safeguard customer data, only browsers which receive security updates from
          the browser manufacturer are considered for support. We have implemented this policy to ensure that we can
          provide an excellent experience to a wide user base.
        </p>
        <Title headingLevel="h4"> Cookies and Javascript </Title>
        <p>
          To successfully interact with our websites and services, your browser must meet the following feature
          requirements:
        </p>
        <ul>
        ...
        <p>
          We validate against and fully support our customers&#39; use of the past two major releases of the following
          browsers:
        </p>
        <ul>
